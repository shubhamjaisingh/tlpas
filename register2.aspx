<%@ Page Title="OTP Based" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="register2.aspx.cs" Inherits="_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style>
        body {
            background-image: url(http://localhost:49748/icon/reg3.png);
            background-size:100%;
