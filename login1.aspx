<%@ Page Title="Pattern Based" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="login1.aspx.cs" Inherits="Default2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
      <style>
        body {
            background-image: url(http://localhost:49748/icon/login2.png);
            background-size:100%;
